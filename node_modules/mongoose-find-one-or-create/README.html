...
</style><title>README</title></head><body><h1 id="mongoose-find-one-or-create">mongoose-find-one-or-create</h1>
<p>Mongoose plugin to add static method findOneOrCreate to a schema</p>
<pre><code>% npm install mongoose-find-one-or-create
</code></pre>

<pre><code>var findOneOrCreate = require('mongoose-find-one-or-create');
